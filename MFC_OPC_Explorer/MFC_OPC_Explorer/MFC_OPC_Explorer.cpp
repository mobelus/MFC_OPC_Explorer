...
// MFC_OPC_Explorer.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFC_OPC_ExplorerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CMFC_OPC_ExplorerApp

CMFC_OPC_ExplorerApp::CMFC_OPC_ExplorerApp()
{
...
// Единственный объект CMFC_OPC_ExplorerApp

CMFC_OPC_ExplorerApp theApp;


// инициализация CMFC_OPC_ExplorerApp

BOOL CMFC_OPC_ExplorerApp::InitInstance()
{
